...
Name                                | Description                                                                                                                                                                        | Type                                                       
----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -----------------------------------------------------------
`instances                          ` | Total number of PVC Groups detected in the cluster. This doesn't equal to the number of instance pod created.                                                                      | int                                                        
`readyInstances                     ` | Total number of ready instances in the cluster. This equals to the number of ready instances pods.                                                                                 | int                                                        
